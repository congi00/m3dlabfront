...
// Template HTML per il corpo della mail del preventivo
              ...
              <tr>
                <td style="padding:20px 28px; color:#333;">
                  ...
                  <p style="margin:18px 0 0; color:#666; font-size:13px;">
                    Se vuoi procedere con l'ordine o modificare i parametri, rispondi pure a questa email o visita il nostro sito.
                  </p>
                </td>
              </tr>
